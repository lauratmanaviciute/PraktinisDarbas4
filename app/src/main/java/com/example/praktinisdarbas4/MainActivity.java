    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.add_note_activity:
                Intent addActivityIntent = new Intent(getApplicationContext(), com.example.praktinisdarbas4.AddNoteActivity.class);
                startActivity(addActivityIntent);
                return true;
            case R.id.delete_note_activity:
                Intent deleteActivityIntent = new Intent(getApplicationContext(), com.example.praktinisdarbas4.DeleteNoteActivity.class);
